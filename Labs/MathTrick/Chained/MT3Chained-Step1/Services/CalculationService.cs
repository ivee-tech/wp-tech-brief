...
namespace MathTrick3Step1.Services
{
    public class CalculationService : ICalculationService
    {
        ...
        public List<CalculationStepModel> CalculateStep(int pickedNumber, double currentResult)
        {
            ...
            currentResult = pickedNumber * multiplier;
            steps.Add(new CalculationStepModel()
            {
                CalcStep = "1",
                CalcPerformed = $"{pickedNumber} x {multiplier}",
            ...
            else
            {
                ...
                //    "currentResult" : 12.0
                //}
                steps.AddRange(_restApiHelper.MakeNestedPOSTCall(fullUri, package.ToString(), "1"));
            }
            return steps;
        }
    }
